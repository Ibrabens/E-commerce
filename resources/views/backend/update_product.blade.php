    ...
    <div class='container'>
        ...
        <div class="card">
            <div class=" card-header bg-white ">
                <span class="h4"> Modifie Produit</span>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{route('product.update',$product->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"  class="@error('name') is-invalid @enderror form-control" id="name" name="name" value="{{$product->name}}">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="@error('reference') is-invalid @enderror form-control" id="reference" name="reference"  value="{{$product->reference}}">
                        @error('reference')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="@error('description') is-invalid @enderror form-control" id="description" rows="2" name="description">{{$product->description}}</textarea>
                        @error('description')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="@error('price') is-invalid @enderror form-control" id="price" name="price"  value="{{$product->price}}">
                        @error('price')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
